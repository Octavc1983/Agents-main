...
export const SelectionBar: React.FC<SelectionBarProps> = ({
  ...
  return (
    <div
      className={['selection-bar', className].filter(Boolean).join(' ')}
      role="toolbar"
    ...
    >
      ...
      {onSelectAll && (
        <TextLink onClick={onSelectAll} className="selection-bar__link">
          Select All
        </TextLink>
      )}
      ...
      {/* Filter count + Clear all filters */}
      <span className="selection-bar__filter-count">
        {filterCount} filters
      </span>
      {onClearFilters && (
        <TextLink onClick={onClearFilters} className="selection-bar__link">
          Clear all filters
        </TextLink>
      )}

...
### Pattern
Search input + status filter + cloud provider filter + active filter chips + count display + clear-all action.
...
### Pattern
Chip with color-coded background and optional icon based on status enum value.

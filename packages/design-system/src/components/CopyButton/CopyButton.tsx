...
export const CopyButton: React.FC<CopyButtonProps> = ({
  value, label, dismissAfter = 2000, className, 'aria-label': ariaLabel,
}) => {
    ...
    <span className={['copy-btn', className].filter(Boolean).join(' ')}>
      ...
      {copied && (
        <span className="copy-btn__badge" role="status" aria-live="polite">
          <svg className="copy-btn__badge-bg" width="91" height="27" viewBox="0 0 91 27" fill="none" preserveAspectRatio="none" aria-hidden="true">
            <path d="M11.3134 0.5H82.201C86.3432 0.5 89.701 3.85786 89.701 8V19C89.701 23.1421 86.3432 26.5 82.201 26.5H11.3134C7.17123 26.5 3.81335 23.1421 3.81335 19V16.7842C3.81332 16.2834 3.56359 15.8155 3.14734 15.5371L0.722534 13.916C0.426454 13.718 0.426458 13.282 0.722534 13.084L3.14734 11.4629C3.56359 11.1845 3.81332 10.7166 3.81335 10.2158V8C3.81335 3.85787 7.17123 0.50001 11.3134 0.5Z" fill="var(--copy-badge-bg)" stroke="var(--copy-badge-border)" />
          </svg>
